   ...
   var allMarker = [];
    ...
    function n(e, a, n, t, r) {
        var i, s, c, l = {}, h = new google.maps.Geocoder, d = $("#currcateg").html();
        l = "" !== a ? {address: a} : {latLng: e}, r && (d = "#WindowContainer" === n && $(".mainWrapper").hasClass("res_Small") ? $("#merchantCat").val() : Ba), so = ro = io = to = "", h.geocode(l, function(e, r) {
    ...
    function l(e, a, o, n, t, r) {
        ...
        "get" === a ? ($.ajaxSetup({url: e,type: "GET",contentType: i}), null != n && $.ajaxSetup({data: n})) : $.ajaxSetup({url: e,type: "POST",data: n,contentType: i}), null !== Po && Po.abort(), $.ajax({dataType: "json",timeout: ajaxTimeout,success: function(e) {
                void 0 !== t && t(e, n)
            },error: function() {
                void 0 !== r && r()
            }})
    ...
    function h(e, a, o, n, t, r) {
        var i = o ? "application/json" : "application/x-www-form-urlencoded; charset=UTF-8";
        $.ajaxSetup("get" === a ? {url: e,type: "GET",contentType: i} : {url: e,type: "POST",data: n,contentType: i}), $.inArray(Lo, vo) < 0 && null !== Po && Po.abort(), Lo = e, Po = $.ajax({dataType: "json",timeout: ajaxTimeout,success: function(e) {
                void 0 !== t && t(e)
            },error: function() {
                void 0 !== r && r()
            }})
    ...
    function C(e, a) {
        var o, n = e.split("|"), t = $.map(a[e], function(e, a) {
            return a
        }), r = [], i = [], s = 0, c = 0, l = "", h = "";
    ...
    function f(e, a) {
        if ($(".currcat").html() != atmname) {
            var o, n, t = "";
            t = e > Ka ? Ka : e, n = void 0 === b("dom_country") ? "" : b("dom_country"), o = {merchantCount: e,noOfResultsInThisPage: t,pageNum: 0,perPageResults: Ka,category: a,dom_country: n}, l(uo, "post", !1, o)
        }
    }
    function b(e) {
    ...
    function k(e) {
        ...
        var o = e.position.toString().slice(1, e.position.toString().lastIndexOf(".") + 7), n = o.split(",");
    ...
    function L(e, a, o) {
        if ($(".currcat").html() != atmname) {
            ...
            var t = {merchantID: e,category: a,reqid: o,dom_country: n};
            l(Co, "post", !1, t)
        }
    }
    function S() {
        var e = "", a = contextPath + "/resources/images/markersprite" + (Math.floor(Xa / 10) + 1) + ".png";
        ...
        window.nMark = new google.maps.Marker({position: qa[Na],animation: google.maps.Animation.DROP,map: ea,title: za[Na].merchantName,icon: e,zIndex: 100});
        nMark.metadata = {type: "point",id: Xa}, 0 === Na && $(".mainWrapper").hasClass("res_Small") ? (Fa = nMark, Fa.setZIndex(1e3)) : void 0 !== ha && ha - 1 === Xa && (Fa = nMark, Fa.setZIndex(1e3)), Na += 1, Xa += 1, Oa.push(nMark),allMarker.push(nMark), google.maps.event.addListener(n, "click", function() {
            if (o("rmaction", "click_MapPin"), Fa !== this) {
                var e, a = "", n = this.metadata.id, t = "";
                if ($(".active").removeClass("active"), $(".suggestion .merchantDetailsContainer").each(function() {
                    ...
                    k(this);
                    var r = da, i = JSON.stringify({merchantId: t,latitude: Ga,longitude: Va,language: na});
                    l(r, "post", !0, i, Go)
                } else {
    ...
    function x(e) {
        ...
        }, 3e3)) : (ja = e.coords.latitude, Ua = e.coords.longitude, Ha = new google.maps.LatLng(ja, Ua), "" != So && So.setMap(null), So = new google.maps.Marker({position: Ha,map: ea,title: mylocationplaceholder,icon: contextPath + "/resources/images/MyLocation.png"})), $(".promptImageMobile #locationServicesPrompt").hide(), $("#search").removeClass("noLocation"), "home" === ko && $("#mylocationicon .myLocationIcon,#mylocationicon .compassIcon").show()
    }
    function P(e) {
    ...
    function R(e, a, n) {
        ...
        var i, s = [{featureType: "transit.station.airport",elementType: "labels.text",stylers: [{visibility: "on"}]}, {featureType: "transit.station.airport",elementType: "labels",stylers: [{visibility: "off"}]}, {featureType: "poi",elementType: "labels",stylers: [{visibility: "off"}]}];
        if (i = {zoom: 10,center: r,mapTypeId: google.maps.MapTypeId.ROADMAP,styles: s,streetViewControl: !1,draggable: !0,zoomControl: !0,scrollwheel: !0,disableDoubleClickZoom: !1,mapTypeControl: !1,zoomControlOptions: {style: google.maps.ZoomControlStyle.MEDIUM,position: google.maps.ControlPosition.RIGHT_TOP},panControlOptions: {position: google.maps.ControlPosition.TOP_RIGHT}}, void 0 === ea) {
            ea = init;
            var c = $("#mapContainer");
        ...
        $("mainWrapper").hasClass("res_Small") || ($("#mapContainer").css("width", "100%"), $("#mapContainer").css("float", "none"), google.maps.event.trigger(ea, "resize")), google.maps.event.trigger(ea, "resize"), ea.fitBounds(Ja), r = ea.getCenter(), google.maps.event.addDomListener(window, "resize", function() {
            _(r)
        }), $(".compassIcon div").hasClass("myLocationBlueIcon") && (ea.getBounds().contains(new google.maps.LatLng(ja, Ua)) ? $(".compassIcon div").addClass("myLocationBlueIcon").removeClass("myLocationIcon") : $(".compassIcon div").addClass("myLocationIcon").removeClass("myLocationBlueIcon")), "" != ja && ($("#mylocationicon .myLocationIcon,#mylocationicon .compassIcon").show(), "" != So && So.setMap(null), So = new google.maps.Marker({position: Ha,map: ea,title: mylocationplaceholder,icon: contextPath + "/resources/images/MyLocation.png"})), $("body").scrollTo($(".mainWrapper"), 500, {axis: "y"}), $("#suggestionList").append('<li class="empty"></li>'), $("#suggestionList").scrollTo($(".first"), 500), void 0 !== ha && $("#suggestionsListContainer").hasClass("userClicked") && $("#suggestionList").scrollTo($(".active"), 500), void 0 == n ? o("layertrack", "SearchDetails:ListView") : o("layertrack", "SearchDetails:ListView:" + n)
    }
    function O(e, a, o) {
        if ($(".currcat").html() != atmname) {
            var n = JSON.stringify({noOfResultsInThisPage: e,pageNum: a,perPageResults: o,language: na});
            l(mo, "post", !0, n)
        }
    }
    function E() {
    ...
    function z() {
        s(Oa), $("#mapContainer").show(), $("#mapContainer").css("height", "250px"), (Wo > 0 || _o > 0 || Fo > 0) && 0 > No && $("#mapContainer").css("height", "140px"), $(".dining").removeClass("fixed"), $("#locationDeatailsContainer").removeClass("locationfixed"), $(".navOptions").removeClass("navfixed"), $(".navOptions,#ReportProblemContainer,#locationDeatailsContainer").hide(), $("#mapContainer").css("margin-top", "0px"), $("#suggestionsListContainer").show(), "" != ja && $("#mylocationicon .myLocationIcon,#mylocationicon .compassIcon").show(), ea.setZoom(12), ea.setOptions({draggable: !0,zoomControl: !0,scrollwheel: !0,disableDoubleClickZoom: !1}), $("#mapOverlay").show(), $("#suggestionList").scrollTo($(".active"), 500), google.maps.event.trigger(ea, "resize"), ea.fitBounds(Ja)
    }
    function H() {
    ...
    function U() {
        ...
        if (pa = ho + "//" + lo + contextPath + "/mersearch/getMerchantList" + aa, $(".searchIconOverlay").css("background-position", "-79px -52px"), "" == $("#searchContainer .searchLocation").val() && "" === ja)
            ...
            var a = $(".CatologueMenu .currcat").html(), o = "", t = "";
            oo = "", no = "";
            var r = "";
            if ("" != $("#searchContainer .searchMerchant").val() && $("#searchContainer .searchMerchant").val() != $("#searchContainer .searchMerchant").attr("placeholder") ? (r = $("#searchContainer .searchMerchant").val(), yo = $("#searchContainer .searchMerchant").val()) : yo = "", $(".currcat").html() === atmname && (pa = ga, o = "", t = ""), $(".preLoader").show(), $("#MainContainer,.dining,#searchContainer").hide(), "" == $("#searchContainer .searchLocation").val() || Wa)
                "" != ja ? 0 === $("#searchContainer .searchLocation").val().length ? ($(".longErrorContainer").show(), $(".longErrorHeading").html(emptySerachError), $("#searchContainer,.preLoader,.dining").hide()) : (Io = "", Za = new google.maps.LatLng(ja, Ua), n(Za, "", "#searchContainer", function() {
                    e = JSON.stringify({merchantName: r,category: m(a),subCategory: o,latitude: ja,longitude: Ua,recommId: t,language: na}), l(pa, "post", !0, e, nn, en)
                ...
                "" != i && (Io = i), n("", i, "#searchContainer", function() {
                    e = JSON.stringify({merchantName: r,category: m(a),subCategory: o,latitude: oo,longitude: no,recommId: t,language: na}), l(pa, "post", !0, e, nn, en)
                }, !1)
            }
        }
    }
    function j(e, a, o) {
        if ($(".currcat").html() != atmname) {
            if (-1 == $.inArray(e.keyCode, Jo) && (o.find("#searchSuggestionsContainer .SearchSuggestionsList").hide(), o.find("#searchSuggestionsContainer").hide(), a.css("color", "#000"), o.find(".SearchSuggestionsList").text(""), o.find(" #suggestionType").text(""), $(".merchantActive").removeClass("merchantActive"), a.val().length >= 3)) {
                ...
                $.ajax({url: n,type: "POST",contentType: "application/x-www-form-urlencoded; charset=UTF-8",timeout: ajaxTimeout,data: {searchString: a.val()},success: function(e) {
                        var a;
    ...
    function Z(e) {
        var a = {en_AU: [langaus, "AU"],fr_FR: [langfr, "FR"],en_GB: [languk, "UK"],en_US: [langus, "US"]};
    ...
    function G() {
        aa = b("sys"), na = b("intcLang"), oa = b("intcLang").toLowerCase(), Z(b("intcLang")), a(), $(".searchMerchant").placeholder(), $(".preLoader").show(), $(".filterComplete, .searchComplete,#reportFeedbackConformation").hide(), $(".mainWrapper").hasClass("res_Large") ? ya = wa[Math.floor(Math.random() * wa.length)] : $(".mainWrapper").hasClass("res_Medium") && (ya = ka[Math.floor(Math.random() * ka.length)]), $(".mainWrapper").css({"background-image": "url(" + contextPath + "/resources/images/" + ya + ")"}), aa = "bigdata" === aa ? "/BigData" : "undefined" !== aa ? "/" + aa : "", da = ho + "//" + lo + contextPath + "/mersearch/getMerchantDetails" + aa, pa = ho + "//" + lo + contextPath + "/mersearch/getMerchantList" + aa, ga = pa.replace("getMerchantList", "getATMList"), "en_us" != oa && "fr_fr" != oa && $(".subscript").hide();
        var e = {dom_country: b("dom_country")};
    ...
    function K() {
        ...
        if ("" == $("#SearchTypeContainer .searchLocation").val() && "" === ja)
            ...
            "" != ja ? "" == $("#SearchTypeContainer .searchLocation").val() ? ($(".longErrorContainer").show(), $(".longErrorHeading").addClass("mobservdown"), $(".longErrorHeading").html(emptySerachError), $("#MainContainer,.preLoader,.dining").hide()) : (Io = "", Za = new google.maps.LatLng(ja, Ua), n(Za, "", "#MainContainer", function() {
                e = JSON.stringify({merchantName: "",category: "dining",subCategory: "",latitude: ja,longitude: Ua,recommId: "",language: na}), l(pa, "post", !0, e, rn, Xo)
            ...
            "" != a && (Io = a), n("", a, "#MainContainer", function() {
                e = JSON.stringify({merchantName: "",category: "dining",subCategory: "",latitude: oo,longitude: no,recommId: "",language: na}), l(pa, "post", !0, e, rn, Xo)
            }, !1)
        }
    }
    function Q(e) {
    ...
    var ea, aa, oa, na, ta, ra, ia, sa, ca, la, ha, da, pa, ga, ma, $a, ua, Ca, va, fa = "", ba = ["bg-mob-breakfast.jpg", "bg-mob-cooking.jpg", "bg-mob-hotelbell.jpg"], wa = ["bg-desk-breakfast.jpg", "bg-desk-cooking.jpg", "bg-desk-hotelbell.jpg"], ka = ["bg-tab-breakfast.jpg", "bg-tab-cooking.jpg", "bg-tab-hotelbell.jpg"], ya = ba[Math.floor(Math.random() * ba.length)], La = !0, Sa = !1, Da = !1, Ma = "", Ia = !0, xa = "", Pa = !1, Ta = !1, Wa = !1, _a = [], Aa = function(e) {
        var a = [], o = {types: ["(regions)"]};
        return a.googleobject = new google.maps.places.Autocomplete(document.getElementById(e), o), a.inputID = e, _a[e] = a, V(a), a
    }, Ra = !1, Oa = [], Ea = "", Ba = "", Fa = "", Na = 0, za = [], Ha = "", Ja = "", qa = [], Ua = "", ja = "", Za = "", Ga = "", Va = "", Ka = "", Qa = 0, Ya = "", Xa = "", eo = "", ao = "", oo = "", no = "", to = "", ro = "", io = "", so = "", co = [], lo = location.host, ho = location.protocol, po = ho + "//" + lo + contextPath + "/mersearch/getCategoryInfo", go = ho + "//" + lo + contextPath + "/mersearch/getAllowedCountryList", mo = ho + "//" + lo + contextPath + "/mersearch/eosRecording", $o = ho + "//" + lo + contextPath + "/mersearch/reportProblem", uo = ho + "//" + lo + contextPath + "/mersearch/eosListReport", Co = ho + "//" + lo + contextPath + "/mersearch/eosMerchantDetailReport", vo = [go, po, $o, uo], fo = "", bo = "", wo = "", ko = "", yo = "", Lo = "", So = "", Do = " ", Mo = "", Io = "", xo = !1, Po = null, To = navigator.userAgent.toLowerCase(), Wo = To.indexOf("blackberry 9900"), _o = To.indexOf("bb10; kbd"), Ao = To.indexOf("gt-p3110"), Ro = To.indexOf("gt-p5110"), Oo = To.indexOf("gt_p6800"), Eo = To.indexOf("blackberry"), Bo = To.indexOf("bb10"), Fo = -1, No = To.indexOf("chrome"), zo = "", Ho = "", Jo = [38, 40, 9, 16, 17, 18, 19, 20, 27, 33, 34, 35, 36, 45], qo = $(".deskRec").html(), Uo = "", jo = To.indexOf("chrome/"), Zo = To.indexOf("android");
    To = To.indexOf("safari/"), $.fn.isOnScreen = function() {
        var e = $("body").scrollTop(), a = $(window), o = {top: a.scrollTop(),left: a.scrollLeft()};
        ...
        if (t > 0 && o.bottom < n.bottom) {
            var r = $("html, body");
            r.animate({scrollTop: t}, "500", "swing")
        }
    };
    var Go = function(e) {
        var a;
        ...
        var p = new google.maps.LatLng(t.merchantLat, t.merchantLong), g = "";
        if ($(".res_Small #suggestionsListContainer, .res_Medium #suggestionsListContainer").hide(), $("#locationDeatailsContainer").show(), $(".mainWrapper").hasClass("res_Small"))
            ea.setOptions({draggable: !1,zoomControl: !1,scrollwheel: !1,disableDoubleClickZoom: !0}), $("#mapContainer").css("height", "125px"), google.maps.event.trigger(ea, "resize"), ea.panTo(p), ea.setZoom(16), g = $(".CatologueMenu .currcat").html();
        else {
            g = $("#currcateg").text();
            var m = $(window).width();
        ...
        var a = $(".searchSubheadingCity").html().replace($(".searchMerchant").attr("placeholder"), ""), t = new google.maps.LatLng(ea.getCenter().lat(), ea.getCenter().lng());
        ...
        $(".mainWrapper").hasClass("res_Small") && (r = Do, fo = Mo), r == allcat && (r = ""), pa = ho + "//" + lo + contextPath + "/mersearch/getMerchantList" + aa, $("#currcateg").html() === atmname && (pa = ga, r = ""), Ho = Ya, n(new google.maps.LatLng(oo, no), "", "#WindowContainer", function() {
            var e = JSON.stringify({merchantName: a,category: m($("#currcateg").html()),subCategory: r,latitude: oo,longitude: no,recommId: fo,language: na});
            h(pa, "post", !0, e, Vo)
        }, !1)
    }, Yo = function() {
        ...
        var t = e.merchListRespBean.merchantCount, r = $(".CatologueMenu .currcat").html();
        ...
        if (La = !1, $("body,html").scrollTop(0), $(".dining-inner .searchFieldLocation .searchLocation").val() === $(".dining-inner .searchFieldLocation .searchLocation").attr("placeholder") && $(".dining-inner .searchFieldLocation .searchLocation").val(""), $(".diningDesktopContainer .searchMerchant").val($(".diningDesktopContainer .searchMerchant").val().replace($(".diningDesktopContainer .searchMerchant").attr("placeholder"), "")), pa = ho + "//" + lo + contextPath + "/mersearch/getMerchantList" + aa, $("#currcateg").html() === atmname && (pa = ga), $(".preLoader").show(), $("#MainContainer").hide(), oo = "", no = "", 0 === $(".dining-inner .searchFieldLocation .searchLocation").val().length || Wa)
            "" != ja ? 0 === $(".dining-inner .searchFieldLocation .searchLocation").val().length ? ($(".preLoader").hide(), $("#MainContainer,.validationContainer").show()) : (Za = new google.maps.LatLng(ja, Ua), n(Za, "", "#MainContainer,.desktopLoginContainer", function() {
                var e = JSON.stringify({merchantName: $(".diningDesktopContainer .searchMerchant").val(),category: m($("#currcateg").text()),subCategory: "",latitude: ja,longitude: Ua,recommId: "",language: na});
                l(pa, "post", !0, e, tn, Yo)
            ...
            Io = fa = e, n("", e, "#MainContainer,.desktopLoginContainer", function() {
                var e = JSON.stringify({merchantName: $(".diningDesktopContainer .searchMerchant").val(),category: m($("#currcateg").text()),subCategory: "",latitude: oo,longitude: no,recommId: "",language: na});
                l(pa, "post", !0, e, tn, Yo)
            }, !1)
        }
    }, dn = function() {
        ...
        if ($(".searchDesktop .searchMerchant").val($(".searchDesktop .searchMerchant").val().replace($(".searchDesktop .searchMerchant").attr("placeholder"), "")), pa = ho + "//" + lo + contextPath + "/mersearch/getMerchantList" + aa, $("#currcateg").html() === atmname && (pa = ga), oo = "", no = "", $(".genricloader").show(), "" == $(".searchDesktop .searchLocation").val() || Wa) {
            ...
            Za = new google.maps.LatLng(ja, Ua), n(Za, "", "#WindowContainer", function() {
                var a = JSON.stringify({merchantName: $.trim($(".searchDesktop .searchMerchant").val()),category: m($("#currcateg").html()),subCategory: e,latitude: ja,longitude: Ua,recommId: fo,language: na});
                l(pa, "post", !0, a, sn)
            }, !1)
        } else {
            var a = $(".searchDesktop .searchLocation").val();
            n("", a, "#WindowContainer", function() {
                var a = JSON.stringify({merchantName: $.trim($(".searchDesktop .searchMerchant").val()),category: m($("#currcateg").html()),subCategory: e,latitude: oo,longitude: no,recommId: fo,language: na});
                l(pa, "post", !0, a, sn, an)
            }, !1)
        }
        ...
        if (void 0 === e && (e = ""), oo = "", no = "", "" === Ga && (Ga = ja, Va = Ua), "" != $.trim($("#filterContainerMain .searchLocation").val()) && (Io = $("#filterContainerMain .searchLocation").val(), $("#filterContainerMain .searchLocation").val($.trim($("#filterContainerMain .searchLocation").val())), $("#searchContainer .searchLocation").val($.trim($("#filterContainerMain .searchLocation").val())), $(".mainWrapper").hasClass("ie9") && $(".searchLocation").callplaceholder($.trim($("#filterContainerMain .searchLocation").val()))), Do = e, Mo = $("#recCat").val(), $("#WindowContainer").hide(), $(".preLoader").show(), Io = "", "" == $("#filterContainerMain .searchLocation").val() || Wa)
            "" != ja ? 0 === $("#filterContainerMain .searchLocation").val().length ? ($("#filterContainerMain,.preLoader,.genricloader,.dining").hide(), $("#WindowContainer,.longErrorContainer").show(), $(".longErrorHeading").html(emptySerachError)) : (Za = new google.maps.LatLng(ja, Ua), n(Za, "", "#WindowContainer", function() {
                var a = JSON.stringify({merchantName: yo,category: m($("#merchantCat").val()),subCategory: e,latitude: ja,longitude: Ua,recommId: Mo,language: na});
            ...
            n("", a, "#WindowContainer", function() {
                var a = JSON.stringify({merchantName: yo,category: m($("#merchantCat").val()),subCategory: e,latitude: oo,longitude: no,recommId: Mo,language: na});
    ...
    $("#mobileLandSearchField").keypress(function(e) {
        ...
        if (n.origin.y = n.origin.y + 60, a.setIcon(n), a.setZIndex(1e3), Fa = Oa[$(this).find(".merchantDetailsContainer .sno").text() - 1 - Qa], $(".mainWrapper").hasClass("res_Small") && (i(Oa), Fa.setMap(ea)), $(".currcat").html() != atmname) {
            ...
            var r = da, s = JSON.stringify({merchantId: e,latitude: Ga,longitude: Va,language: na});
            ...
            if (ea.panTo(c), $(".mainWrapper").hasClass("res_Small"))
                ea.setOptions({draggable: !1,zoomControl: !1,scrollwheel: !1,disableDoubleClickZoom: !0}), $("#mapContainer").css("height", "125px"), google.maps.event.trigger(ea, "resize"), ea.panTo(c), ea.setZoom(16);
            else {
                var h = $(window).width();
        ...
        if (0 != $.trim(ca).length) {
            var a = {merchantName: $("#merchantTitle").html(),merchantID: e,merAddress: $("#address").text(),reportDesc: $.trim(ca),otherFlag: xo};
        ...
        $(".mainWrapper").hasClass("res_Small") ? (z(), ko = "home", $("body").scrollTo($(".mainWrapper"), 500, {axis: "y"})) : (ko = "home", $("#locationDeatailsContainer").hide(), $("#suggestionsListContainer").show(), "" != ja && $("#mylocationicon .myLocationIcon,#mylocationicon .compassIcon").show(), $("#mapContainer").css("width", "100%"), $("#mapContainer").css("float", "right"), google.maps.event.trigger(ea, "resize"), ea.panTo(Fa.getPosition()))
    }), $(".filterMainClose").on("click ", function() {
        $(".CatologueMenu .currcat").css("color", "#ffffff"), $(".CatologueMenu .caret").css("background-position", "-106px -66px"), eo = "", "mapview" === ao ? "home" === ko ? (z(), $("#filterContainerMain").hide(), $("body,html").scrollTo($(".mainWrapper"), 500, {axis: "y"})) : ($("#filterContainerMain").hide(), "details" === ko ? (H(), $("body,html").scrollTo($(".mainWrapper"), 500, {axis: "y"})) : "report" === ko && $("#ReportProblemContainer").show()) : ($("#filterContainerMain,#mapOverlay,#loginPromptContainer,#searchContainer").hide(), $("#MainContainer").show(), eo = "")
        ...
        $(".searchIconOverlay").css("background-position", "-79px -52px"), eo = "", "mapview" === ao ? "home" === ko ? ($("body,html").scrollTo(".mainWrapper", 500, {axis: "y"}), $("#searchContainer").hide(), z()) : "details" === ko ? H() : "report" === ko && ($("#filterContainerMain,#searchContainer").hide(), $("#ReportProblemContainer").show()) : ($("#MainContainer").show(), $("#mapOverlay,#loginPromptContainer,#searchContainer").hide(), eo = "")
        ...
        if ("mapview" === ao)
            if ($(".currcat").html() != sa) {
                ...
                a === allcat && (a = ""), $(".subcatDesk, .subcatDesk1").html(allcat), Za = new google.maps.LatLng(Ga, Va), n(Za, "", "#MainContainer", function() {
                    var o = JSON.stringify({merchantName: "",category: e,subCategory: a,latitude: Ga,longitude: Va,recommId: fo,language: na});
                    l(pa, "post", !0, o, ln, an)
                }, !0)
            } else
                $(".filterContainerDesktop").hide();
        ...
        if (wo = $(".filterRecomnd .filterSubcategoryContainer span.selected input").val(), ta = $(".subcatDesk1").text(), ra = $(".subcatDesk").text(), $(".filterSubcategory input").parent(".selectedCheckbox").each(function() {
            ...
            var r = JSON.stringify({merchantName: yo,category: m($("#currcateg").text()),subCategory: a,latitude: Ga,longitude: Va,recommId: wo,language: na});
            l(pa, "post", !0, r, cn, an)
        } else
            $(".genricloader").hide()
    }), $(".questionMark, .questionMarkMobile").on("click ", function() {
        La = !1, o("layertrack", "FAQ"), $(".mainWrapper").hasClass("res_Small") ? $(".faqOuterContainer").show() : $(".faqOuterContainer").show().css("height", $("#MainContainer").height()), $(".faqOuterContainer .panelContentInner a").attr("target", "_blank"), "mapview" === ao && $(".faqOuterContainer").css("height", "718px"), "mapview" === ao && $(window).height() > 1050 && $(".faqOuterContainer").css("height", "879px"), $(".mainWrapper").css({"background-image": "url(" + contextPath + "/resources/images/" + ya + ")"}), $(".mainWrapper").hasClass("res_Small") && ($("#MainContainer").css("overflow", "hidden"), $("#MainContainer").css("height", "820px")), $(".faqOuterContainer").scrollTop(0), $("body").scrollTop(0)
        ...
        var e = $(this).siblings(".panelContent").children(".panelContentInner").offset(), a = e.top + $(this).siblings(".panelContent").children(".panelContentInner").height() + 30;
        if (a > $(window).height()) {
            var o = a - $(window).height() + $(".faqOuterContainer").scrollTop();
            $(".faqOuterContainer").animate({scrollTop: o}, "500", "swing")
        }
